      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <blockquote className="text-3xl md:text-4xl lg:text-5xl font-display text-foreground leading-tight mb-10 tracking-wide">
            ...
            IN <span className="text-gradient-primary text-shadow-neon">DIGITAL TRANSFORMATION</span>."
          </blockquote>
          
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            We combine <span className="text-primary font-semibold">cutting-edge AI solutions</span> with 
            human creativity to deliver <span className="text-accent font-semibold">exceptional results</span>.
          </p>

          {/* Attribution */}
          <div className="flex items-center justify-center gap-4 mb-16">
            <div className="w-16 h-16 rounded-2xl bg-gradient-accent flex items-center justify-center glow-accent">
              <span className="text-2xl font-display font-bold text-accent-foreground">R</span>
            </div>
            <div className="text-left">
              <p className="font-display text-xl font-bold text-foreground tracking-wider">RANDY MAZIN</p>
              <p className="text-muted-foreground font-medium">Founder, MazinMind Digital</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-vibrant rounded-2xl p-8 hover:glow-primary transition-all group border border-primary/20">
              <h4 className="font-display text-2xl font-bold text-gradient-primary mb-3 tracking-wider">20+ YEARS</h4>
            ...
            <div className="glass-vibrant rounded-2xl p-8 hover:glow-accent transition-all group border border-accent/20">
              <h4 className="font-display text-2xl font-bold text-gradient-accent mb-3 tracking-wider">HYBRID APPROACH</h4>
              <p className="text-muted-foreground">
            ...
            <div className="glass-vibrant rounded-2xl p-8 hover:glow-electric transition-all group border border-electric/20">
              <h4 className="font-display text-2xl font-bold text-gradient-electric mb-3 tracking-wider">ROI FOCUSED</h4>
              <p className="text-muted-foreground">
