...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "We work with businesses across various industries including technology, e-commerce, healthcare, finance, manufacturing, and professional services. Our solutions are adaptable and can be customized to meet the specific needs of any industry.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "We offer comprehensive AI services including AI Consulting, AI-Driven Marketing, Agile & DevOps solutions, AI Content Creation, and Custom Software Development. Each service is designed to help businesses automate processes, gain insights from data, and improve efficiency.",
      },
      {
        question: "Can you help with SEO and digital marketing?",
        answer:
          "Absolutely! Our AI-Driven Marketing services include advanced SEO optimization, predictive analytics, automated campaign management, and real-time performance tracking. We use AI to analyze data and optimize your marketing strategies for maximum ROI.",
      },
      {
        question: "Do you build custom software applications?",
        answer:
          "Yes, we develop custom web and mobile applications using modern technologies like React, Next.js, TypeScript, Node.js, and cloud platforms (AWS, Azure, GCP). We can build everything from simple MVPs to complex enterprise solutions.",
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes! We offer a free 30-minute initial consultation where we discuss your business needs, challenges, and goals. This helps us understand how we can best help you and provides you with an opportunity to learn more about our approach.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "We provide comprehensive post-project support including training, documentation, and ongoing maintenance. We believe in building long-term partnerships with our clients and are always available to help optimize and scale your solutions as your business grows.",
      },
      {
        question: "How quickly can you start on a new project?",
        answer:
          "We can typically begin the discovery phase within 1-2 weeks of signing an agreement. Actual development timelines depend on project scope and complexity, but we're known for our rapid delivery without compromising quality.",
      },
      {
        question: "Do you work with startups or only established businesses?",
        answer:
          "We work with businesses of all sizes, from startups to enterprises. For startups, we often focus on building MVPs and scalable foundations. For established businesses, we typically focus on optimization, automation, and digital transformation initiatives.",
      },
    ],
  },
];
            ...
            {faqs.map((category) => {
              ...
              return (
                <div key={category.category} className="mb-16">
                  <h2
                    className={`text-3xl font-display font-bold mb-8 ${colors.text} tracking-wider`}
                  >
                    {category.category}
                  </h2>
