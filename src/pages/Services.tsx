...
const services = [
  ...
  },
  {
    ...
    description:
      "Harness the power of AI to supercharge your marketing efforts. Our data-driven approach ensures every campaign delivers maximum impact and measurable results.",
    features: [
  ...
  },
  {
    ...
    description:
      "Streamline your operations with our enterprise-grade automation solutions. We specialize in AWS, cloud optimization, and agile methodologies that scale with your business.",
    features: [
  ...
  },
  {
    ...
    description:
      "Build powerful, scalable applications that drive your business forward. Our experienced team delivers custom solutions using cutting-edge technologies.",
    features: [
  ...
  },
  {
    ...
    description:
      "Create compelling content at unprecedented speed without sacrificing quality. Our AI-powered content solutions drive engagement and conversions across all channels.",
    features: [
...
const processSteps = [
  {
    ...
    description:
      "30-minute initial consultation to understand your needs and develop a custom solution roadmap.",
  },
  {
    icon: Lightbulb,
    title: "Strategy Development",
    description:
      "Comprehensive AI readiness assessment and transparent development process using Agile Scrum.",
  },
  {
    icon: Rocket,
    title: "Implementation",
    description:
      "Rapid deployment with continuous iteration and optimization based on real-time feedback.",
  },
  {
    icon: Users,
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              business operations, drive sustainable growth, and maximize your
              ROI.
            </p>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="lg:w-2/3">
                    <h2
                      className={`text-4xl md:text-5xl font-display font-bold mb-4 tracking-wider ${colors.split(" ")[0]}`}
                    >
                      {service.title}
                    </h2>
                    <p className="text-xl text-gradient-accent mb-4 font-medium">
                      {service.tagline}
                    </p>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-8 tracking-wider">
              READY TO{" "}
              <span className="text-gradient-neon text-shadow-neon">
                TRANSFORM
              </span>{" "}
              YOUR BUSINESS?
            </h2>
